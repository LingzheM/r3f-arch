...
import { DEFAULT_WINDOW_HEIGHT, DEFAULT_WINDOW_SILL, DEFAULT_WINDOW_WIDTH, OpeningPlacement, OpeningSide } from "./opening";
...
export const WindowNode = BaseNode.extend({
  ...
  width: z.number().positive().default(DEFAULT_WINDOW_WIDTH),
